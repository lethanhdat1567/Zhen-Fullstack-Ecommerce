...
import ServiceCategoryForm from "@/app/admin/services/category/new/ServiceCategoryForm";
...
function ServiceCategoryUpdatePage() {
    ...
    const fetchCategory = async () => {
        try {
            const res = await serviceCategoryService.detail(
        ...
        <div className="mx-auto w-4xl">
            ...
            {loading ? (
                ...
                <ServiceCategoryForm
                    activeLang={activeLang}
                    form={form}
                    updatedId={categoryId as string}
                />
            )}
        </div>
    );
