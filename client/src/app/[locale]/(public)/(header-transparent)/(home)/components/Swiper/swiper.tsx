...
import SwiperNavigate from "@/app/[locale]/(public)/(header-transparent)/(home)/components/Swiper/components/SwiperNavigate/SwiperNavigate";
...
export default function Swiper() {
    ...
    return (
        <div className="relative mt-(--header-height) h-[70vh] w-full sm:h-[85vh] lg:mt-0 lg:h-screen">
            {/* Swiper */}
            <SwiperCore
                modules={[Autoplay]}
                slidesPerView={1}
