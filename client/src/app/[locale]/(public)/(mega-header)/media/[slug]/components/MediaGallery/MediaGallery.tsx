...
import { chunkArray } from "@/app/[locale]/(public)/(mega-header)/media/[slug]/components/MediaGallery/helpers";
import MediaOverlay from "@/app/[locale]/(public)/(mega-header)/media/[slug]/components/MediaGallery/components/MediaOverlay/MediaOverlay";
